...
public abstract class ImageDownloader{
	 ...
	 */
	public void downloadFile(ImageLoaderRequest req, DiskLruCache to, ImageCache.ProgressCallback callback, ImageCache.ImageDownloadInfo info, Runnable onSuccess, Consumer<Throwable> onError){
	}
